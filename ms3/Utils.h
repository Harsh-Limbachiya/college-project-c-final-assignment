...
namespace sdds
{
    ...
    public:
        ...
        int getInt(int min, int max, const char* prompt, const char* errMsg = nullptr);
        double getDouble(double min, double max, const char* prompt, const char* errMsg = nullptr);
    };
    extern Utils ut;
}
